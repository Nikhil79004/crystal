...
function Product() {
  return (
    ...
    <div className='grid grid-cols-1 p-2 mt-10 mb-10 md:grid-cols-2 lg:grid-cols-2'>
      ...
      <div key={index} className='flex flex-col items-center justify-center p-10 mx-auto border border-blue-400 rounded-lg h-72 w-60 bg-gradient-to-r from-white to-zinc-400'>
